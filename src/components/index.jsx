  ...
  return (
    <div className="inner-container">
      <div className="left-container"> 
        ...
        {!mostrarBotonesEliminar && <button onClick={handleEditar}>Editar</button>} {/* Mostrar el botón de "Editar" solo si los botones de eliminar no están visibles */}
        {mostrarBotonesEliminar && <button onClick={handleGuardar}>Guardar</button>} {/* Mostrar el botón de "Guardar" solo si los botones de eliminar están visibles */}
      ...
      <div className="right-container">
        ...
        <form>
          ...
          <br />
          <button type="button" onClick={handleAgregarLibro}>Agregar Libro</button>
        </form>
      </div>
    </div>
  );
